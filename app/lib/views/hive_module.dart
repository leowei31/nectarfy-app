...
class _HiveModuleState extends State<HiveModule> {
  ...
  final List<ActionItem> actionList2 = [
    ActionItem(actionId: 'a1', hiveId: 'h2', actionDescription: 'Varroa Mite: our Nectarfy hive has detected the presence of Varroa Mite. '),
    ActionItem(actionId: 'a2', hiveId: 'h3', actionDescription: 'Varroa Mite: our Nectarfy hive has detected the presence of Varroa Mite. ')
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        HiveListController(allHives: allHives, callbackFn: changeCategoryHandler),
        HiveList(listOfHives: hives, actionList: actionList, allHives: allHives,)
      ],
