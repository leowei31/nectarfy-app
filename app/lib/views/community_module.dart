...
class _CommunityModuleState extends State<CommunityModule> {
  ...
  Widget build(BuildContext context) {
    ...
    void _handleCategory(Category cat) {
      ...
      Navigator.push(
        context, 
        MaterialPageRoute(builder: (context) => CategoryPosts(category: cat,))
      );
    }
    ...
    Future<void> fetchCategories() async {
      ...
      try {
        ...
        for (var element in arrResponse) {
          final Category temp = Category(id: element['_id'], title: element['title'], description: element['description']);
          cats.add(SingleCategory(category: temp, onPressedFn: _handleCategory,));
        }
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                !isLoaded ? const Text('LOADING!') : Expanded(
