...
class _CommunityBoardState extends State<CommunityBoard> {
  ...
  Widget build(BuildContext context) {
    ...
    const _communityBoardDesc  = "Welcome to the community boad! Connect with industry leading experts and your friendly neighborhood beekeepers";
          ...
          child: Column(
            ...
            children: <Widget>[
              Container( 
                ...
                child: const Text(_communityBoardTitle, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
              ),
              Container(
                margin: const EdgeInsets.only(bottom: 25),
                child: const Text(_communityBoardDesc,  style: TextStyle(fontSize: 12))
              ),
              SizedBox(
                height: 40,
                child: TextField(
